...
const Map = dynamic(() => import("@/components/ui/Map"), {
  ...
  loading: () => (
    <div style={{
      height: "100%", width: "100%", backgroundColor: "#f1f5f9",
      borderRadius: "16px", display: "flex", alignItems: "center",
      justifyContent: "center", flexDirection: "column", gap: "8px",
    }}>
      <div style={{ fontSize: "28px" }}>🗺️</div>
      <div style={{ fontSize: "13px", color: "#64748b", fontWeight: 500 }}>Chargement de la carte...</div>
    </div>
  ),
});
...
export default function ZonesPage() {
  return (
    <>
            ...
            >
              ...
              <aside style={{
                ...
                <h2 style={{
                  ...
                  <MapPin style={{ width: "15px", height: "15px", color: "#2563eb" }} aria-hidden="true" />
                ...
                >
                  {ZONES_COMMUNES.map((name) => (
                    <span
                      ...
                      style={{
                        fontSize: "12px", fontWeight: name === INTERVENTION_BASE_CITY ? 700 : 500,
                        color: name === INTERVENTION_BASE_CITY ? "#1d4ed8" : "#475569",
                        backgroundColor: name === INTERVENTION_BASE_CITY ? "#eff6ff" : "#f8fafc",
                        border: name === INTERVENTION_BASE_CITY ? "1px solid #bfdbfe" : "1px solid #e2e8f0",
                ...
                <div style={{
                  ...
                  <p style={{ fontSize: "12px", color: "#78350f", lineHeight: 1.55, margin: 0 }}>
                    {INTERVENTION_OUT_OF_ZONE_NOTE}{" "}
                    <Link
                      href="/contact"
      ...
      <style jsx global>{`
        .zones-grid { grid-template-columns: 1fr 340px; }
        @media (max-width: 1024px) {
          .zones-grid { grid-template-columns: 1fr !important; }
        }
        .leaflet-container { height: 100%; width: 100%; border-radius: 16px; }
      `}</style>
    </>
  );
}
