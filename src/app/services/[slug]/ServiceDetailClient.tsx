    ...
    <>
      ...
      <PageWrapper>
        ...
        <section style={{
          ...
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px 60px", position: "relative", zIndex: 1 }}>
            <motion.nav
              style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "24px", flexWrap: "wrap" }}
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
            >
              <Link href="/" style={{ color: "#94a3b8", fontSize: "13px", textDecoration: "none", fontWeight: 500 }}>Accueil</Link>
              <span style={{ color: "#475569", fontSize: "13px" }}>›</span>
              <Link href="/services" style={{ color: "#94a3b8", fontSize: "13px", textDecoration: "none", fontWeight: 500 }}>Services</Link>
              <span style={{ color: "#475569", fontSize: "13px" }}>›</span>
              <span style={{ color: "#60a5fa", fontSize: "13px", fontWeight: 600 }}>{displayTitle}</span>
            </motion.nav>
            ...
            <motion.p
              style={{ fontSize: "clamp(15px, 2vw, 19px)", color: "#94a3b8", maxWidth: "600px", lineHeight: 1.7, marginBottom: "32px" }}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <section style={{ backgroundColor: "#f8fafc", padding: "80px 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            <div
              style={{ display: "grid", gridTemplateColumns: "1fr 380px", gap: "48px", alignItems: "start" }}
            ...
            >
                  ...
                  <div style={{
                    ...
                    {service.description.map((para, i) => (
                      <p key={i} style={{
                        ...
                        lineHeight: 1.85, marginBottom: i < service.description.length - 1 ? "16px" : 0,
                      }}>
                        {para}
                      </p>
                    ))}
                    ...
                    >
                      {service.prestations.map((item, i) => (
                        <motion.div
                          ...
                          whileHover={{ backgroundColor: "#eff6ff", borderColor: "#bfdbfe" }}
                        >
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                      {service.avantages.map((item, i) => (
                        <motion.div
                          key={i}
                          style={{ display: "flex", alignItems: "center", gap: "12px", fontSize: "15px", color: "#bfdbfe", fontWeight: 500 }}
                          initial={{ opacity: 0, x: -16 }}
                          whileInView={{ opacity: 1, x: 0 }}
                          viewport={{ once: true }}
                ...
                {service.processus && (
                  <ScrollReveal direction="up" delay={0.3}>
                    <div style={{
                      ...
                      <h2 style={{ fontSize: "22px", fontWeight: 800, color: "#0f172a", marginBottom: "32px" }}>
                        ...
                        {service.processus.map((step, i) => (
                          <motion.div
                            ...
                            style={{
                              ...
                              paddingBottom: i < service.processus!.length - 1 ? "28px" : "0",
                              position: "relative",
                            }}
                            initial={{ opacity: 0, y: 20 }}
              ...
              <div style={{ position: "sticky", top: "100px", display: "flex", flexDirection: "column", gap: "20px" }}>
                ...
                <ScrollReveal direction="right">
                  <div style={{
                    backgroundColor: "#FFFFFF", borderRadius: "24px",
                    padding: "32px", boxShadow: "0 8px 40px rgba(29,78,216,0.12)",
                ...
                <ScrollReveal direction="right" delay={0.1}>
                  <div style={{
                    ...
                    <p style={{ fontSize: "13px", color: "#64748b", lineHeight: 1.6, margin: 0 }}>
                      Basés à {INTERVENTION_BASE_CITY}, nous intervenons dans toute la {INTERVENTION_AREA_LABEL}.
                    </p>
                    <Link href="/zones" style={{ textDecoration: "none" }}>
                      <motion.div
                        style={{
                          display: "inline-flex", alignItems: "center", gap: "6px",
                          marginTop: "12px", fontSize: "13px", fontWeight: 600, color: "#2563eb",
                        }}
                        whileHover={{ gap: "10px" }}
                      >
                  ...
                  <div style={{
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "12px" }}>
                      {[
                        ...
                        <li key={item.text} style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "13px", color: "#475569", fontWeight: 500 }}>
                    ...
                    <Link href="/realisations" style={{ textDecoration: "none" }}>
                      <motion.div
                        style={{
                          display: "inline-flex", alignItems: "center", gap: "6px",
                          marginTop: "16px", fontSize: "13px", fontWeight: 600, color: "#2563eb",
                        }}
                        whileHover={{ gap: "10px" }}
                      >
            ...
            {relatedServices.length > 0 && (
              <ScrollReveal direction="up">
                <div style={{ marginTop: "64px" }}>
                  <h2 style={{ fontSize: "22px", fontWeight: 800, color: "#0f172a", marginBottom: "24px", textAlign: "center" }}>
                  ...
                  >
                    {relatedServices.map((related) => (
                      <Link key={related.slug} href={`/services/${related.slug}`} style={{ textDecoration: "none" }}>
                        <motion.div
                          style={{
                          ...
                          whileHover={{ y: -4, boxShadow: "0 12px 32px rgba(29,78,216,0.1)", borderColor: "#bfdbfe" }}
                        >
                          <span style={{ fontSize: "24px" }} aria-hidden="true">{related.icon}</span>
                          <h3 style={{ fontSize: "16px", fontWeight: 700, color: "#0f172a", margin: 0 }}>
                            {related.title}
                          </h3>
                          <p style={{ fontSize: "13px", color: "#64748b", lineHeight: 1.6, margin: 0, flex: 1 }}>
                            {related.description}
                          </p>
                          <span style={{ fontSize: "13px", fontWeight: 600, color: "#2563eb", display: "flex", alignItems: "center", gap: "6px" }}>
        ...
        {/* CTA Final */}
        <section style={{ background: "linear-gradient(135deg, #0f172a, #1e3a8a)", padding: "80px 0" }}>
          <div style={{
            maxWidth: "700px", margin: "0 auto", padding: "0 24px",
            textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "24px",
          }}>
            <motion.h2
              style={{ fontSize: "clamp(26px, 4vw, 40px)", fontWeight: 900, color: "#FFFFFF", lineHeight: 1.2 }}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            >
            ...
            <motion.p
              style={{ fontSize: "16px", color: "#94a3b8", lineHeight: 1.7 }}
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
            >
              Devis gratuit sous 24 h — contactez-nous via le formulaire ou par téléphone.
            </motion.p>
            <motion.div
      ...
      <style jsx global>{`
        .service-detail-grid { grid-template-columns: 1fr 380px; }
        ...
        @media (max-width: 1024px) {
          ...
          .related-services-grid { grid-template-columns: repeat(2, 1fr) !important; }
        }
