...
export default function ContactPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (!confirmSend) {
      setError("Merci de cocher la case de confirmation avant d'envoyer.");
      return;
    }
    setLoading(true);
    try {
      ...
      <PageWrapper>
        ...
        <section style={{ backgroundColor: "#f8fafc", padding: "80px 0" }}>
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px" }}>
            <div
              style={{ display: "grid", gridTemplateColumns: "1fr 1.6fr", gap: "48px", alignItems: "start" }}
                      ...
                      {INFOS.map((info, i) => (
                        ...
                        >
                          ...
                          <div>
                            ...
                            {info.href ? (
                              <a href={info.href} style={{ fontSize: "14px", fontWeight: 600, color: "#0f172a", textDecoration: "none" }}>
                                {info.value}
                              </a>
                            ) : (
                ...
                <div style={{
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }} className="form-row">
                        <InputField label="Nom complet *" name="name" value={formData.name} onChange={handleChange} placeholder="Jean Dupont" />
                        <InputField label="Téléphone" name="phone" value={formData.phone} onChange={handleChange} placeholder="+32 489 125 099" />
                      </div>

                      {/* Email */}
                      <InputField label="Email *" name="email" value={formData.email} onChange={handleChange} placeholder="jean@exemple.be" type="email" />
                      ...
                      >
                        <p style={{ fontSize: "13px", color: "#0369a1", margin: "0 0 12px", lineHeight: 1.55 }}>
                          <strong>Où se situe le lieu à nettoyer ?</strong> Cette information nous aide à préparer
                          votre devis et à confirmer notre zone d&apos;intervention.
                        </p>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                          ...
                          <select
                            name="commune"
                            aria-label="Commune ou localité du chantier"
                        ...
                        <p style={{ fontSize: "12px", color: "#64748b", margin: "12px 0 0", lineHeight: 1.5 }}>
                          {INTERVENTION_OUT_OF_ZONE_NOTE}{" "}
                          <Link href="/zones" style={{ color: "#2563eb", fontWeight: 600 }}>
                            Voir nos zones
                          </Link>
                        </p>
                      </motion.div>
                      ...
                      {/* Anti-spam discret : case à cocher + honeypot + délai côté serveur */}
                      <label
                        style={{
                          display: "flex",
                          ...
                          padding: "14px 16px",
                          borderRadius: "12px",
                          border: `2px solid ${confirmSend ? "#bfdbfe" : "#e2e8f0"}`,
                          backgroundColor: confirmSend ? "#f8fafc" : "#FFFFFF",
                          cursor: "pointer",
                          fontSize: "14px",
                          color: "#334155",
                          lineHeight: 1.5,
                      ...
                      >
                        ...
                        />
                        <span>
                          Je confirme l&apos;envoi de ma demande de devis
                        </span>
                      </label>
