    ...
    <>
      <motion.header
        ...
        style={{
          ...
          boxShadow: isScrolled ? "0 4px 24px rgba(30,64,175,0.08)" : "none",
      ...
      >
        ...
        >
          ...
          >
            ...
            <Button href="/contact" size="sm" icon="right" className="min-w-[120px]">
              Devis gratuit
            </Button>
          </div>
          ...
          <motion.button
            ...
            style={{
              ...
              justifyContent: "center",
              cursor: "pointer",
              backgroundColor: isScrolled ? "#f1f5f9" : "rgba(255,255,255,0.25)",
              color: "#1e293b",
